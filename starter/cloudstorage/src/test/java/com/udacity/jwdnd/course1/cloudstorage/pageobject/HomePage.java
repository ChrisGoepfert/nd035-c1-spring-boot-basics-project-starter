...
public class HomePage {
    ...
    public List<Note> getNotes() {
        return notes.stream()
                .map(
                        note -> {
                            String desc = note.findElement(By.className("noteDescription")).getText();
                            String title = note.findElement(By.className("noteTitle")).getText();
    ...
    public List<Credential> getCreds() {
        return creds.stream()
                .map(
                        cred -> {
                            String url = cred.findElement(By.className("credsUrl")).getText();
                            String username = cred.findElement(By.className("credsUsername")).getText();
                            String pwd = cred.findElement(By.className("credsPwd")).getText();
    ...
    public void openEditModalForCreds(String credsurl) {
        Optional<WebElement> targetCreds =
                creds.stream()
                        .filter(
                                credsElement ->
